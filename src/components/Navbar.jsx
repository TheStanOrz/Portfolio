    ...
    >
      <div className='w-full flex justify-between items-center max-w-8xl mx-auto'>
        ...
        >
          ...
          <p className='text-white text-[18px] font-bold cursor-pointer flex'>JiaWei-Wu &nbsp;
        ...
        <ul className='list-none hidden sm:flex flex-row gap-10'>
          {navLinks.map((link)=>(
            <li
            key={link.id}
            className={`${active===link.title? "text-white" : "text-secondary"} hover:text-white text-[18px] font-medium cursor-pointer7`}
